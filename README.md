# CrimsonGX
CrimsonGX is a modern browser built using PyQt5 / PyQt6, designed for speed, customization, and enhanced browsing experience.

Multiple versions are available:

4.x – Recommended: The most stable and reliable version for everyday use.

5.x – Experimental: New features are being tested, minor bugs may appear.
